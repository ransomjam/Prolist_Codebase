...
import { Building, Filter, Search, MapPin, Eye, MessageCircle, Shield, Star } from 'lucide-react';
...
export default function RealEstate() {
  ...
  const { data: products = [], isLoading, error, refetch } = useQuery({
    ...
    refetchInterval: 30000 // Refetch every 30 seconds to catch new properties
  });
  ...
  if (isLoading) {
    return (
      <div className="p-6">
        <h2 className="text-3xl font-bold text-primary mb-4">Real Estate Properties</h2>
